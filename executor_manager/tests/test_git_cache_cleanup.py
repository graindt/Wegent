...
class TestGitCacheCleanupManager:
    ...
    @patch(
        "executor_manager.executors.docker.git_cache_volume_manager.list_user_volumes"
    )
    ...
    def test_cleanup_respects_protected_users(self, mock_size, mock_delete, mock_list):
        ...
        assert (
            1 == mock_delete.call_count
        )  # delete only called for user 123, not for protected user 1
